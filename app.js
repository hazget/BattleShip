document.addEventListener('DOMContentLoaded', () => {
    ...
    //generate comp's ships in random place
    ...
    function checkWinner() {
        if (destroyerCount === 2) {
            infoDisplay.innerHTML = 'You blow up cpu destroyer';
            destroyerCount = 10
        }
        if (submarineCount === 3) {
            infoDisplay.innerHTML = 'You blow up cpu submarine';
            submarineCount = 10
        }
        if (cruiserCount === 3) {
            infoDisplay.innerHTML = 'You blow up cpu cruiser';
            cruiserCount = 10
        }
        if (battleshipCount === 4) {
            infoDisplay.innerHTML = 'You blow up cpu battleship';
            battleshipCount = 10
        }
        if (carrierCount === 5) {
            infoDisplay.innerHTML = 'You blow up cpu carrier';
            carrierCount = 10
        }

        if (cpuDestroyerCount === 2) {
            infoDisplay.innerHTML = 'Cpu blow up Your destroyer';
            cpuDestroyerCount = 10
        }
        if (cpuSubmarineCount === 3) {
            infoDisplay.innerHTML = 'Cpu blow up Your submarine';
            cpuSubmarineCount = 10
        }
        if (cpuCruiserCount === 3) {
            infoDisplay.innerHTML = 'Cpu blow up Your cruiser';
            cpuCruiserCount = 10
        }
        if (cpuBattleshipCount === 4) {
            infoDisplay.innerHTML = 'Cpu blow up Your battleship';
            cpuBattleshipCount = 10
        }
        if (cpuCarrierCount === 5) {
            infoDisplay.innerHTML = 'Cpu blow up Your carrier';
            cpuCarrierCount = 10
        }
